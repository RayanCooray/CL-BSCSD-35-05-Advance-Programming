...
public class DashboardViewController {
    ...
    public void show(String key) {
        ...
        switch (key) {
            case "patients" -> {
                view.pageTitle().setText("Patients");
                view.content().getChildren().add(new PatientView().root());
            }
            case "dentists" -> {
                view.pageTitle().setText("Dentists");
                view.content().getChildren().add(new DentistView().root());
            }
            case "treatments" -> {
                view.pageTitle().setText("Treatments");
                view.content().getChildren().add(new TreatmentView().root());
            }
            case "appointments" -> {
                view.pageTitle().setText("Appointments");
                view.content().getChildren().add(new AppointmentView().root());
            }
            case "history" -> {
                view.pageTitle().setText("Treatment History");
                view.content().getChildren().add(new TreatmentHistoryView().root());
            }
            case "billing" -> {
                view.pageTitle().setText("Billing & Payments");
                view.content().getChildren().add(new BillingView().root());
            }
            case "reports" -> {
                view.pageTitle().setText("Reports");
                view.content().getChildren().add(new ReportsView().root());
            }
            case "users" -> {
                view.pageTitle().setText("User Management");
                view.content().getChildren().add(new UserManagementView().root());
            }
            default -> {
                view.pageTitle().setText("Dashboard");
                view.content().getChildren().add(new DashboardHomeView().root());
            }
        }
    }
    ...
    private String labelFor(String key) {
        return switch (key) {
            ...
            case "history" -> "Treatment History";
    ...
    public void logout() {
        try {
            if (session.getToken() != null) auth.logout(session.getToken());
