...
public class DashboardView {
    ...
    private VBox buildSidebar() {
        ...
        Label brand = new Label("SUNRISE DENTAL");
        brand.getStyleClass().add("brand");
        Label sub = new Label("CLINIC MANAGEMENT");
        ...
        side.getChildren().addAll(brandRow, nav);
        VBox.setVgrow(nav, Priority.ALWAYS);
        Button logout = new Button("Sign out", lk.sunrise.dentalclinic.ui.util.Ui.icon(org.kordamp.ikonli.fontawesome5.FontAwesomeSolid.SIGN_OUT_ALT, 15));
    ...
    private HBox buildTopbar() {
        ...
        bar.getChildren().addAll(pageTitle, spacer, userLabel);
        return bar;
    }
    ...
    public boolean canAccess(String key) {
        ...
        return switch (key) {
            ...
            case "patients", "appointments", "billing" ->
                    r == UserRole.ADMIN || r == UserRole.RECEPTIONIST || r == UserRole.DENTIST;
